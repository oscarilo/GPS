...
public class fr_Generacion_Vale_Resguardo_Bienes extends javax.swing.JFrame {
    ...
    public fr_Generacion_Vale_Resguardo_Bienes() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            PdfContentByte txt_No_inventario = writer.getDirectContent();
            PdfContentByte txt_No_serie = writer.getDirectContent();
            PdfContentByte txt_Descripcion = writer.getDirectContent();
            PdfContentByte txt_Marca = writer.getDirectContent();
            PdfContentByte txt_Modelo = writer.getDirectContent();
            PdfContentByte txt_Color = writer.getDirectContent();
            ...
            /*ZONA PENDIENTE*/
            //No_inventario
            txt_No_inventario.saveState();
            txt_No_inventario.beginText();
            txt_No_inventario.setLineWidth(1.0f);
            txt_No_inventario.setRGBColorStroke(0x10, 0x10, 0x10);
            txt_No_inventario.setFontAndSize(bf, 9);
            txt_No_inventario.setTextMatrix(35, 535);
            txt_No_inventario.showText(No_inventario);
            txt_No_inventario.endText();
            txt_No_inventario.restoreState();
            //No_serie
            txt_No_serie.saveState();
            txt_No_serie.beginText();
            txt_No_serie.setLineWidth(1.0f);
            txt_No_serie.setRGBColorStroke(0x10, 0x10, 0x10);
            txt_No_serie.setFontAndSize(bf, 9);
            txt_No_serie.setTextMatrix(100, 535);
            txt_No_serie.showText(No_serie);
            txt_No_serie.endText();
            txt_No_serie.restoreState();
            //No_Descripcion
            txt_Descripcion.saveState();
            txt_Descripcion.beginText();
            txt_Descripcion.setLineWidth(1.0f);
            txt_Descripcion.setRGBColorStroke(0x10, 0x10, 0x10);
            txt_Descripcion.setFontAndSize(bf, 9);
            txt_Descripcion.setTextMatrix(184, 535);
            txt_Descripcion.showText(Descripcion);
            txt_Descripcion.endText();
            txt_Descripcion.restoreState();
            //Marca
            txt_Marca.saveState();
            txt_Marca.beginText();
            txt_Marca.setLineWidth(1.0f);
            txt_Marca.setRGBColorStroke(0x10, 0x10, 0x10);
            txt_Marca.setFontAndSize(bf, 9);
            txt_Marca.setTextMatrix(370, 535);
            txt_Marca.showText(Marca);
            txt_Marca.endText();
            txt_Marca.restoreState();
            //Modelo
            txt_Modelo.saveState();
            txt_Modelo.beginText();
            txt_Modelo.setLineWidth(1.0f);
            txt_Modelo.setRGBColorStroke(0x10, 0x10, 0x10);
            txt_Modelo.setFontAndSize(bf, 9);
            txt_Modelo.setTextMatrix(422, 535);
            txt_Modelo.showText(Modelo);
            txt_Modelo.endText();
            txt_Modelo.restoreState();
            //Color
            txt_Color.saveState();
            txt_Color.beginText();
            txt_Color.setLineWidth(1.0f);
            txt_Color.setRGBColorStroke(0x10, 0x10, 0x10);
            txt_Color.setFontAndSize(bf, 9);
            txt_Color.setTextMatrix(508, 535);
            txt_Color.showText(Color);
            txt_Color.endText();
            txt_Color.restoreState();
